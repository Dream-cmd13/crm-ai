  ...
  const groups = [
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'product-categories', label: '产品分类', icon: FolderKanban },
        { id: 'product-series', label: '产品系列', icon: ListTodo },
        { id: 'spec-groups', label: '规格组', icon: ListTodo },
        { id: 'product-specs', label: '产品规格', icon: ListTodo },
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'wechat-binding', label: '微信绑定', icon: Users },
