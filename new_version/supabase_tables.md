...
### crm\_sample\_order\_status\_enum (样品订单状态枚举)

| 值                     | 描述    |
| --------------------- | ----- |
| leader\_reject        | 主管驳回  |
| wait\_leader\_examine | 待主管审核 |
| completed             | 已完成   |
| stay\_follow\_up      | 待跟进   |
| cancellation          | 已取消   |
| closure               | 已关闭   |

### crm\_sales\_order\_status\_enum (销售订单状态枚举)

| 值                               | 描述       |
| ------------------------------- | -------- |
| un\_paid                        | 未支付      |
| partial\_payment                | 部分支付     |
| monthly\_paid\_audit            | 月结审核中    |
| monthly\_paid\_audit\_failed    | 月结审核失败   |
| offline\_payment\_audit         | 线下付款审核中  |
| offline\_payment\_audit\_failed | 线下付款审核失败 |
| waiting\_delivery               | 待发货      |
| partial\_delivery               | 部分发货     |
| delivered                       | 已发货      |
| await\_comment                  | 待评价      |
| completed                       | 已完成      |
| not\_submit                     | 未提交      |
| cancellation                    | 已取消      |
| admin\_cancellation             | 管理员取消    |
| admin\_cancellation\_audit      | 管理员取消审核中 |
| system\_cancel                  | 系统取消     |
| await\_follow                   | 待跟进      |
| await\_refund                   | 待退款      |
| await\_receipt\_refund          | 待收货退款    |
| completed\_refund               | 退款完成     |

### crm\_quotation\_status\_enum (报价单状态枚举)

| 值                     | 描述   |
| --------------------- | ---- |
| quotation\_complete   | 报价完成 |
| terminated            | 已终止  |
| manual\_quotation     | 手工报价 |
| timeout\_cancellation | 超时取消 |
| user\_cancelled       | 用户取消 |
...
| 字段名             | 数据类型        | 约束                                           | 默认值    | 描述     |
| --------------- | ----------- | -------------------------------------------- | ------ | ------ |
| id              | integer     | generated by default as identity primary key | <br /> | 系列ID   |
| series\_no      | text        | not null                                     | ''     | 系列编号   |
| name            | text        | not null                                     | <br /> | 系列名称   |
| category\_id    | integer     | references ba\_cptype(id) on delete set null | <br /> | 分类ID   |
...
| 字段名                          | 数据类型                         | 约束                                           | 默认值    | 描述     |
| ---------------------------- | ---------------------------- | -------------------------------------------- | ------ | ------ |
| id                           | integer                      | generated by default as identity primary key | <br /> | 报价单ID  |
| quote\_no                    | text                         | <br />                                       | <br /> | 报价单号   |
| customer\_id                 | text                         | <br />                                       | <br /> | 客户ID   |
| customer\_name               | text                         | <br />                                       | <br /> | 客户名称   |
| project\_id                  | integer                      | references crm\_project(id)                  | <br /> | 项目ID   |
| project\_name                | text                         | <br />                                       | <br /> | 项目名称   |
| quote\_date                  | date                         | <br />                                       | <br /> | 报价日期   |
| status                       | crm\_quotation\_status\_enum | <br />                                       | <br /> | 状态     |
...
| delivery\_method             | text                         | <br />                                       | <br /> | 交付方式   |
| delivery\_time               | timestamptz                  | <br />                                       | <br /> | 交付时间   |
| payment\_method              | int                          | <br />                                       | <br /> | 付款方式   |
| contact\_phone               | text                         | <br />                                       | <br /> | 联系电话   |
| created\_at                  | timestamptz                  | not null                                     | now()  | 创建时间   |
| updated\_at                  | timestamptz                  | not null                                     | now()  | 更新时间   |
| <br />                       | <br />                       | check (id > 0)                               | <br /> | ID正数约束 |
...
| 字段名                      | 数据类型          | 约束                                                       | 默认值    | 描述     |
| ------------------------ | ------------- | -------------------------------------------------------- | ------ | ------ |
| id                       | integer       | generated by default as identity primary key             | <br /> | 明细ID   |
| quotation\_id            | integer       | not null references crm\_quotation(id) on delete cascade | <br /> | 报价单ID  |
...
| currency                 | text          | <br />                                                   | <br /> | 币种     |
| lead\_time               | text          | <br />                                                   | <br /> | 交期     |
| mpq                      | numeric(18,4) | <br />                                                   | <br /> | 最小包装量  |
| moq                      | numeric(18,4) | <br />                                                   | <br /> | 最小起订量  |
| sample\_price            | numeric(18,4) | <br />                                                   | 0      | 样品价    |
| remark                   | text          | <br />                                                   | <br /> | 备注     |
| customer\_material\_no   | text          | <br />                                                   | <br /> | 客户物料号  |
| material\_delivery\_date | date          | <br />                                                   | <br /> | 物料交付日期 |
| created\_at              | timestamptz   | not null                                                 | now()  | 创建时间   |
| updated\_at              | timestamptz   | not null                                                 | now()  | 更新时间   |
| <br />                   | <br />        | check (id > 0)                                           | <br /> | ID正数约束 |
...
| 字段名                           | 数据类型                            | 约束                                           | 默认值    | 描述     |
| ----------------------------- | ------------------------------- | -------------------------------------------- | ------ | ------ |
| id                            | integer                         | generated by default as identity primary key | <br /> | 订单ID   |
| order\_no                     | text                            | unique                                       | <br /> | 订单号    |
| customer\_id                  | text                            | <br />                                       | <br /> | 客户ID   |
| customer\_name                | text                            | <br />                                       | <br /> | 客户名称   |
| project\_id                   | integer                         | references crm\_project(id)                  | <br /> | 项目ID   |
| project\_name                 | text                            | <br />                                       | <br /> | 项目名称   |
| order\_date                   | date                            | <br />                                       | <br /> | 订单日期   |
| status                        | crm\_sales\_order\_status\_enum | <br />                                       | <br /> | 状态     |
| audit\_status                 | text                            | <br />                                       | <br /> | 审核状态   |
| tax\_included\_total\_amount  | numeric(18,2)                   | <br />                                       | 0      | 含税总金额  |
| tax\_excluded\_total\_amount  | numeric(18,2)                   | <br />                                       | 0      | 不含税总金额 |
| total\_amount                 | numeric(18,2)                   | <br />                                       | 0      | 总金额    |
| actual\_received\_amount      | numeric(18,2)                   | <br />                                       | 0      | 实收金额   |
| pending\_amount               | numeric(18,2)                   | <br />                                       | 0      | 待收金额   |
| order\_type                   | int                             | <br />                                       | <br /> | 订单类型   |
| payment\_status               | int                             | <br />                                       | 0      | 支付状态   |
| payment\_method               | int                             | <br />                                       | <br /> | 付款方式   |
| payment\_time                 | timestamptz                     | <br />                                       | <br /> | 付款时间   |
| province                      | text                            | <br />                                       | <br /> | 省      |
| city                          | text                            | <br />                                       | <br /> | 市      |
| district                      | text                            | <br />                                       | <br /> | 区      |
| shipping\_address             | text                            | <br />                                       | <br /> | 收货地址   |
| consignee\_name               | text                            | <br />                                       | <br /> | 收货人    |
| consignee\_phone              | text                            | <br />                                       | <br /> | 收货人电话  |
| customer\_purchase\_order\_no | text                            | <br />                                       | <br /> | 客户采购单号 |
| third\_party\_transaction\_no | text                            | <br />                                       | <br /> | 第三方交易号 |
| sales\_rep                    | text                            | <br />                                       | <br /> | 销售代表   |
| merchandiser                  | text                            | <br />                                       | <br /> | 跟单员    |
| receipt\_time                 | timestamptz                     | <br />                                       | <br /> | 收款时间   |
| receipt\_voucher              | text                            | <br />                                       | <br /> | 收款凭证   |
| source\_document\_no          | text                            | <br />                                       | <br /> | 来源单据号  |
| source\_after\_sale\_no       | text                            | <br />                                       | <br /> | 来源售后单号 |
| advance\_stock\_attachment    | text                            | <br />                                       | <br /> | 预支附件   |
| advance\_stock\_reason        | text                            | <br />                                       | <br /> | 预支原因   |
| is\_advance\_stock            | int                             | <br />                                       | 0      | 是否预支   |
| created\_at                   | timestamptz                     | not null                                     | now()  | 创建时间   |
| updated\_at                   | timestamptz                     | not null                                     | now()  | 更新时间   |
| <br />                        | <br />                          | check (id > 0)                               | <br /> | ID正数约束 |
...
| -------------------------- | ------------- | ----------------------------------------------------------- | ------ | ------ |
| id                         | integer       | generated by default as identity primary key                | <br /> | 明细ID   |
| sales\_order\_id           | integer       | not null references crm\_sales\_order(id) on delete cascade | <br /> | 订单ID   |
| product\_id                | integer       | references ba\_cpinfo(id)                                   | <br /> | 产品ID   |
| product\_name              | text          | <br />                                                      | <br /> | 产品名称   |
| material\_no               | text          | <br />                                                      | <br /> | 物料编号   |
| quantity                   | numeric(18,4) | <br />                                                      | 0      | 数量     |
...
| customer\_name             | text          | <br />                                                      | <br /> | 客户名称   |
| product\_no                | text          | <br />                                                      | <br /> | 产品编号   |
| customer\_material\_no     | text          | <br />                                                      | <br /> | 客户物料号  |
| list\_price                | numeric(18,4) | <br />                                                      | 0      | 列表价    |
| sales\_unit\_price         | numeric(18,4) | <br />                                                      | 0      | 销售单价   |
| line\_total                | numeric(18,2) | <br />                                                      | 0      | 行总价    |
| original\_line\_total      | numeric(18,2) | <br />                                                      | 0      | 原始行总价  |
| order\_type                | int           | <br />                                                      | <br /> | 订单类型   |
| customer\_due\_date        | date          | <br />                                                      | <br /> | 客户交期   |
| due\_date                  | date          | <br />                                                      | <br /> | 交期     |
| packaging\_unit            | text          | <br />                                                      | <br /> | 包装单位   |
| shipping\_method           | text          | <br />                                                      | <br /> | 发货方式   |
| tax\_excluded\_unit\_price | numeric(18,4) | <br />                                                      | 0      | 不含税单价  |
| tax\_excluded\_line\_total | numeric(18,2) | <br />                                                      | 0      | 不含税行总价 |
| discount\_method           | text          | <br />                                                      | <br /> | 折扣方式   |
| created\_at                | timestamptz   | not null                                                    | now()  | 创建时间   |
| updated\_at                | timestamptz   | not null                                                    | now()  | 更新时间   |
| <br />                     | <br />        | check (id > 0)                                              | <br /> | ID正数约束 |
...
| 字段名                          | 数据类型                             | 约束                                           | 默认值    | 描述     |
| ---------------------------- | -------------------------------- | -------------------------------------------- | ------ | ------ |
| id                           | integer                          | generated by default as identity primary key | <br /> | 样品订单ID |
...
| project\_id                  | integer                          | references crm\_project(id)                  | <br /> | 项目ID   |
| project\_name                | text                             | <br />                                       | <br /> | 项目名称   |
| status                       | crm\_sample\_order\_status\_enum | <br />                                       | <br /> | 状态     |
| audit\_status                | text                             | <br />                                       | <br /> | 审核状态   |
| tax\_included\_total\_amount | numeric(18,2)                    | <br />                                       | 0      | 含税总金额  |
| tax\_excluded\_total\_amount | numeric(18,2)                    | <br />                                       | 0      | 不含税总金额 |
| total\_amount                | numeric(18,2)                    | <br />                                       | 0      | 总金额    |
...
| merchandiser                 | text                             | <br />                                       | <br /> | 跟单员    |
| created\_by                  | text                             | <br />                                       | <br /> | 创建人    |
| created\_time                | timestamptz                      | <br />                                       | <br /> | 创建时间   |
| recipient                    | text                             | <br />                                       | <br /> | 收件人    |
| mobile\_phone                | text                             | <br />                                       | <br /> | 手机号    |
| province                     | text                             | <br />                                       | <br /> | 省      |
| city                         | text                             | <br />                                       | <br /> | 市      |
| district                     | text                             | <br />                                       | <br /> | 区      |
| detail\_address              | text                             | <br />                                       | <br /> | 详细地址   |
| reject\_reason               | text                             | <br />                                       | <br /> | 驳回原因   |
| reject\_time                 | timestamptz                      | <br />                                       | <br /> | 驳回时间   |
| sample\_application\_note    | text                             | <br />                                       | <br /> | 申请备注   |
| application\_attachments     | jsonb                            | <br />                                       | <br /> | 申请附件   |
| created\_at                  | timestamptz                      | not null                                     | now()  | 创建时间   |
| updated\_at                  | timestamptz                      | not null                                     | now()  | 更新时间   |
| <br />                       | <br />                           | check (id > 0)                               | <br /> | ID正数约束 |
...
| ------------------------ | ------------- | ------------------------------------------------------------ | ------ | ------ |
| id                       | integer       | generated by default as identity primary key                 | <br /> | 明细ID   |
| sample\_order\_id        | integer       | not null references crm\_sample\_order(id) on delete cascade | <br /> | 样品订单ID |
| product\_id              | integer       | references ba\_cpinfo(id)                                    | <br /> | 产品ID   |
| product\_name            | text          | <br />                                                       | <br /> | 产品名称   |
| material\_no             | text          | <br />                                                       | <br /> | 物料编号   |
| quantity                 | numeric(18,4) | <br />                                                       | 0      | 数量     |
...
| unit\_price              | numeric(18,4) | <br />                                                       | 0      | 单价     |
| line\_total              | numeric(18,2) | <br />                                                       | 0      | 行总价    |
| customer\_material\_no   | text          | <br />                                                       | <br /> | 客户物料号  |
| customer\_material\_name | text          | <br />                                                       | <br /> | 客户物料名  |
| customer\_due\_date      | date          | <br />                                                       | <br /> | 客户交期   |
| created\_at              | timestamptz   | not null                                                     | now()  | 创建时间   |
| updated\_at              | timestamptz   | not null                                                     | now()  | 更新时间   |
| <br />                   | <br />        | check (id > 0)                                               | <br /> | ID正数约束 |
...
| 字段名                          | 数据类型          | 约束                                           | 默认值    | 描述     |
| ---------------------------- | ------------- | -------------------------------------------- | ------ | ------ |
| id                           | integer       | generated by default as identity primary key | <br /> | 退货订单ID |
...
| tax\_included\_total\_amount | numeric(18,2) | <br />                                       | 0      | 含税总金额  |
| tax\_excluded\_total\_amount | numeric(18,2) | <br />                                       | 0      | 不含税总金额 |
| after\_sale\_no              | text          | <br />                                       | <br /> | 售后单号   |
| after\_sale\_qty             | numeric(18,4) | not null                                     | 0      | 售后数量   |
| after\_sale\_type            | integer       | not null                                     | 1      | 售后类型   |
| after\_sale\_reason          | text          | <br />                                       | <br /> | 售后原因   |
| after\_sale\_status          | integer       | not null                                     | 0      | 售后状态   |
| created\_at                  | timestamptz   | not null                                     | now()  | 创建时间   |
| updated\_at                  | timestamptz   | not null                                     | now()  | 更新时间   |
| <br />                       | <br />        | check (id > 0)                               | <br /> | ID正数约束 |
| <br />                       | <br />        | check (after\_sale\_type in (1,2,3))         | <br /> | 售后类型约束 |
| <br />                       | <br />        | check (after\_sale\_status in (0,1,2,3,4))   | <br /> | 售后状态约束 |
...
| ----------------------------- | ------------- | ------------------------------------------------------------ | ------ | ------ |
| id                            | integer       | generated by default as identity primary key                 | <br /> | 明细ID   |
| return\_order\_id             | integer       | not null references crm\_return\_order(id) on delete cascade | <br /> | 退货订单ID |
| product\_id                   | integer       | references ba\_cpinfo(id)                                    | <br /> | 产品ID   |
| product\_name                 | text          | <br />                                                       | <br /> | 产品名称   |
| material\_no                  | text          | <br />                                                       | <br /> | 物料编号   |
| quantity                      | numeric(18,4) | <br />                                                       | 0      | 数量     |
...
| after\_sale\_order\_id        | integer       | references crm\_return\_order(id) on delete set null         | <br /> | 售后单ID  |
| after\_sale\_no               | text          | <br />                                                       | <br /> | 售后单号   |
| material\_qty                 | numeric(18,4) | not null                                                     | 0      | 物料数量   |
| created\_at                   | timestamptz   | not null                                                     | now()  | 创建时间   |
| updated\_at                   | timestamptz   | not null                                                     | now()  | 更新时间   |
| <br />                        | <br />        | check (id > 0)                                               | <br /> | ID正数约束 |
...
| id                         | integer       | generated by default as identity primary key                       | <br /> | 主键ID    |
| material\_no               | text          | <br />                                                             | <br /> | 物料编号    |
| material\_desc             | text          | <br />                                                             | <br /> | 物料描述    |
| tax\_included\_unit\_price | numeric(18,4) | not null                                                           | 0      | 含税单价    |
| tax\_excluded\_unit\_price | numeric(18,4) | not null                                                           | 0      | 不含税单价   |
| sample\_price              | numeric(18,4) | not null                                                           | 0      | 样品价     |
| unit                       | text          | <br />                                                             | <br /> | 单位      |
| lead\_time                 | text          | <br />                                                             | <br /> | 交期      |
| moq                        | numeric(18,4) | <br />                                                             | <br /> | 最小起订量   |
| mpq                        | numeric(18,4) | <br />                                                             | <br /> | 最小包装量   |
| remark                     | text          | <br />                                                             | <br /> | 备注      |
| drawing                    | text          | <br />                                                             | <br /> | 图纸      |
| purchase\_quotation\_id    | integer       | not null references crm\_purchase\_quotation(id) on delete cascade | <br /> | 采购报价单ID |
| created\_by                | text          | <br />                                                             | <br /> | 创建人     |
| created\_at                | timestamptz   | not null                                                           | now()  | 创建时间    |
| updated\_by                | text          | <br />                                                             | <br /> | 更新人     |
| updated\_at                | timestamptz   | not null                                                           | now()  | 更新时间    |
...
| idx\_crm\_product\_series\_category\_id               | crm\_product\_series             | category\_id                           |
...
| idx\_crm\_quotation\_customer\_id                     | crm\_quotation                   | customer\_id                           |
| idx\_crm\_quotation\_project\_id                      | crm\_quotation                   | project\_id                            |
| idx\_crm\_quotation\_item\_quotation\_id              | crm\_quotation\_item             | quotation\_id                          |
| idx\_crm\_sample\_order\_sample\_no                   | crm\_sample\_order               | sample\_no                             |
| idx\_crm\_sample\_order\_status                       | crm\_sample\_order               | status                                 |
| idx\_crm\_sample\_order\_customer\_id                 | crm\_sample\_order               | customer\_id                           |
| idx\_crm\_sample\_order\_item\_sample\_order\_id      | crm\_sample\_order\_item         | sample\_order\_id                      |
| idx\_crm\_sample\_order\_item\_sample\_no             | crm\_sample\_order\_item         | sample\_no                             |
| idx\_crm\_return\_order\_after\_sale\_no              | crm\_return\_order               | after\_sale\_no                        |
| idx\_crm\_return\_order\_after\_sale\_status          | crm\_return\_order               | after\_sale\_status                    |
| idx\_crm\_return\_order\_item\_after\_sale\_order\_id | crm\_return\_order\_item         | after\_sale\_order\_id                 |
| idx\_crm\_purchase\_quotation\_project\_id            | crm\_purchase\_quotation         | project\_id                            |
| idx\_crm\_purchase\_quotation\_customer\_id           | crm\_purchase\_quotation         | customer\_id                           |
| idx\_crm\_purchase\_quotation\_item\_purchase\_id     | crm\_purchase\_quotation\_item   | purchase\_quotation\_id                |
...
- ba\_employeeinfo, ba\_cptype, crm\_product\_series, ba\_cpinfo, ba\_manucustinfo, ba\_customer\_user
- crm\_customer\_contact, crm\_customer\_persona, crm\_inquiry, crm\_lead, crm\_opportunity, crm\_project
- crm\_task\_type, crm\_task, crm\_competitor, crm\_customer\_competitor, crm\_customer\_focus\_swot, crm\_case\_library
